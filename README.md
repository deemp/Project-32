...
- Moreover, if you are taking the DE and Physics courses now, you may earn up to **6** DE points and up to **4** Physics points for an accepted project! (To be decided later)
...
- **Advanced**: model the solution, visualize, and make it interactive! Earn **4** DE points and **4** Physics points more for a cool work.
#### Implementation
